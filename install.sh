...
echo ""
echo "Done. ubersdr-packet is running."
...
echo ""
echo "Edit ${INSTALL_DIR}/${COMPOSE_FILE} to configure UBERSDR_URL, etc."
...
if [[ "${PASS_IS_NEW}" == "1" ]]; then
    ...
    echo "  ${CONFIG_PASS}"
    echo ""
    echo "  This password protects write actions in the web UI (add/remove/reconfigure channels)."
